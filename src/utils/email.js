...
export function buildWelcomeEmailPrompt(cadet, settings) {
  const lines = [
    'Write a warm welcome email FROM 2Lt Andy Ritting (Key Parent & Transportation Officer,',
    'Quakertown Composite Squadron NER-PA-035, Civil Air Patrol, Pennsylvania Wing)',
  ...
  lines.push(
    ...
    '- CAP is the official USAF Auxiliary: aerospace education, leadership, service',
    '- Tuesday evening meetings at Quakertown Airport',
  ...
  lines.push(
    '',
    'Sign off: 2Lt Andy Ritting | Key Parent, Quakertown Composite Squadron (NER-PA-035)',
...
export function buildThirdNightEmailPrompt(cadet, settings) {
  const lines = [
    'Write an encouraging email FROM 2Lt Andy Ritting (Key Parent & Transportation Officer,',
    'Quakertown Composite Squadron NER-PA-035, Civil Air Patrol, Pennsylvania Wing)',
  ...
  lines.push(
    ...
    '- Need CAP Form 15 (CAPF 15) from capnhq.gov -- parent must sign',
    '- $25 annual membership fee at capnhq.gov',
